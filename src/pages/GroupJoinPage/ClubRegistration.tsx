    ...
    return (
        <div className="flex bg-stone-100 flex-col min-h-screen">
            <div className="w-[920px] mx-auto mt-8 flex flex-col flex-grow">
                <h2 className="text-xl text-green-600 font-neoBold mb-10">개인정보 이용약관</h2>
                ...
                <div className="border-2 border-[#B4E3BF] rounded-lg bg-white p-8 mb-4">
                    <ol className="space-y-1.5 list-decimal list-inside">
                        ...
                        <li>상호 존중</li>
                        <li>이성적 만남, 영업 등 동아리와 관련되지 않은 목적 적발시 강퇴!!</li>
                ...
                <div className="space-y-4 bg-white p-8 border-2 border-[#B4E3BF] rounded-lg">
                    <div>
                        <label className="block mb-2 font-neoBold text-sm">1. MBTI (잘 모르면 외향형, 내향형 정도로 작성해주세요.)</label>
                        <input type="text" className="w-full h-8 p-2 border border-gray-300 rounded" />
                    </div>
                    <div>
                        <label className="block mb-2 font-neoBold text-sm">2. 나이 (만 나이)</label>
                        <input type="text" className="w-full h-8 p-2 border border-gray-300 rounded" />
                    </div>
                    <div>
                        <label className="block mb-2 font-neoBold text-sm">3. 가입 시 잘 참여하겠습니까?</label>
                        <input type="text" className="w-full h-8 p-2 border border-gray-300 rounded" />
                    </div>
                </div>
                ...
                <div className="mt-auto mb-10">
                    <label className="flex justify-end items-center mt-4 mb-3">
                        <input type="checkbox" className="form-checkbox" />
                        <span className="text-sm ml-2">위 가입 내용의 정보 이용에 동의합니다.</span>
                    </label>
